label ch4_s1_1:
    ...
    show shadow neutral
    ma "Honestly! How FOOLISH do you think we could possibly be?! After everything you've pulled on us, dear Shadow... for what?!"
    ma "That {i}BITCH?!{/i}"
...
label ch4_s1_3:
    ...
    sn "Well, I'm in. Truth be told, I've been thinking about how weird our repeat encounters are."
...
label ch4_s3_1:
    ...
    "You can think that's because we had no other choice, that it was either fight or die, but that couldn't be further from the truth."
    ...
    "Before I even finish my sentence, Levina aims a gun up there and, without hesitation, fires a bullet."
    ...
    "Multiple robots were crushed underneath the door, but that wasn't enough to deter the others from approaching us."
    show bolt neutral
    show stoneman neutral
