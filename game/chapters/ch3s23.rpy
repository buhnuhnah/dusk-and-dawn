label ch3_s2:
    ...
    show bolt hurt at side onlayer mc
    show shadow neutral at center
    with Fade(0.75, 0.5, 0.5)
    "I almost lose consciousness after that but then I no longer hear them behind us."
    "It worked. But... where should we go?"
    ...
    show aunt matilda surprised at center
    with Fade(1.0, 0.0, 0.0)
...
label ch3_s3_3:
    ...
    hide aunt matilda with dissolve
    show shadow at center with ease
